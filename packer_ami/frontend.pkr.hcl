...
build {
  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "sudo cp class25-26-project2/app/templates/login.html /var/www/html/login.html",
      "sudo cp class25-26-project2/app/templates/home.html /var/www/html/home.html"
    ]
  }
}
